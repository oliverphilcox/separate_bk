...
def main():
    ...
    X_train, y_train = create_bk_dataset(grid_points=GRID_POINTS_TRAINING, func_name=BK_FUNC, func_arg=FUN_ARG, kmin=KMIN, kmax=1.05, n_points_k2=None, scale_invariant=True, k2_sample_version=K2_SAMPLE_VERSION) # expand training set boundaries a little bit. This is hard-coded for now
